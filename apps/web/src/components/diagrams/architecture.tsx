    ...
    >
      ...
      <g>
        <rect
          ...
          strokeWidth="1"
        />
        <text x="56" y="32" className="fill-primary text-[11px] font-medium">
          Your browser
        </text>
        <text x="56" y="52" className="fill-foreground text-[11px]">
          Terminal · SFTP · Editor
        </text>
        <text x="56" y="68" className="fill-foreground text-[11px]">
          WASM SSH client
        </text>
      ...
      />
      <text x="222" y="122" className="fill-muted-foreground text-[10px]">
        SSH ciphertext
      </text>
      ...
      <line
        ...
        markerEnd="url(#arch-arrow)"
      />
      <text x="222" y="232" className="fill-muted-foreground text-[10px]">
        TCP :22
      </text>
      ...
      <g>
        <rect
          ...
          strokeWidth="1"
        />
        <text x="56" y="272" className="fill-foreground text-[11px] font-medium">
          Your server
        </text>
