...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This sets the cookie to keep the sidebar state. Generated by shadcn and
      // left as it was: it is one non-sensitive presentation flag, and the
      // Cookie Store API the rule prefers is not in Safari.
      // biome-ignore lint/suspicious/noDocumentCookie: one presentation flag, no library for it
