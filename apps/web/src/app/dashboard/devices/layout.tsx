...
/**
 * Names the tab for the browsers signed into this account.
 *
 ...
 */
export const metadata = dashboardMetadata("Devices")

export default function Layout({ children }: LayoutProps<"/dashboard/devices">) {
  return children
}
