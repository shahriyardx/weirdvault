...
/**
 * Names the tab for saved shell commands.
 *
 ...
 */
export const metadata = dashboardMetadata("Snippets")

export default function Layout({ children }: LayoutProps<"/dashboard/snippets">) {
  return children
}
