...
const PUBLIC_KEY_LINE =
  "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHk2mQ1r7ZC9tRfV0oXqK3nB8sJyLwDpE6uNaG4vTcXi weirdvault@laptop"
        ...
        <article className="min-w-0 flex-1 space-y-16">
          ...
          <Section id="hosts" icon={<FingerprintIcon />} title="Hosts and sync">
            ...
            <P className="mt-3">
              ...
              deliberate act in the host&apos;s settings, not a prompt you can click through while
              you are busy.
            </P>
            <P className="mt-3">
